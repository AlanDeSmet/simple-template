...
=item * B<-h>, B<--help>  - Help informatoin

=item * B<--template>=I<PATH_TO_FILE> - Specifies the template file to use.  Defaults to "template.html"

=item * B<--dst>=I<PATH_TO_DIR>       - Specifies directory to write output files to. Defaults to "output"
